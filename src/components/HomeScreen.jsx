...
//                                 alignItems: 'center',
//                                 padding: '19px',
//                                 transform: isFocused ? 'scale(1.70)' : 'scale(1)',
//                                 transition: 'transform 0.2s ease'
//                             }}
//                             >
//                             {/* Channel Icon – ALWAYS visible */}
//                             <img
//                             src={ch.icon_url}
//                             alt={ch.title}
//                             style={{
...
//                                 <div style={{ color: '#555', fontSize: '9px' }}>•</div>
...
//             <div style={styles.rightPanel}>
//                 <div style={{ display: 'flex', gap: '10px' }}>
//                     <div style={{ ...headerBaseStyle, width: '1060px',border: '2px solid', overflow: 'hidden' }}>
//                         <div style={{fontSize: '20px', fontWeight: 'bold', animation: 'marquee 15s linear infinite' }}>
//                              • Use Arrows to Navigate • Press Ok to Play • Enjoy Ulka TV •
//                         </div>
//                     </div>
//                 </div>
...
//         container: { 
//             width: '100vw', height: '100vh', backgroundColor: '#000', color: '#fff', 
//             display: 'flex', padding: '2% 2%', boxSizing: 'border-box', overflow: 'hidden', gap: '15px' 
//         },
//         sidebarColumn: { display: 'flex', flexDirection: 'column', backgroundColor: '#0a0a0a', gap: '10px', height: '100%', borderRadius: '8px', border: '1px solid #1a1a1a' },
//         scrollArea: { flex: 1, minHeight: 0, overflowY: 'auto', padding: '10px', scrollbarWidth: 'none' },
//         sidebarItem: (isFocused, isSelected) => ({
...
//             <div style={{ display: 'flex', gap: '12px', height: '100%' }}>
//                 {/* Categories */}
//                 <div style={{ ...styles.sidebarColumn, width: '200px' }}>
//                     <div style={headerBaseStyle}>Categories</div>
//                     <div style={styles.scrollArea} ref={catRef}>
//                         {CATEGORIES.map((cat, i) => (
//                             <div key={i} style={styles.sidebarItem(activeSection === 'categories' && focusedIdx === i, selectedCat === i)}>
...
//                         const isFocused = activeSection === 'channels' && focusedIdx === i;
//                         return (
//                             <div key={ch.id} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px', transform: isFocused ? 'scale(1.70)' : 'scale(1)', transition: 'transform 0.2s ease' }}>
//                                 <img src={ch.icon_url} alt={ch.title} style={{ width: '100px', height: '100px', objectFit: 'contain' }} />
//                                 {isFocused && (
//                                     <div style={{ marginTop: '5px', display: 'flex', alignItems: 'center', gap: '6px', fontWeight: 'bold' }}>
//                                         <div style={{ fontSize: '10px', color: '#9aa3a7' }}>{ch.channel_number}</div>
//                                         <div style={{ color: '#fff', fontSize: '10px' }}>{ch.title}</div>
//                                     </div>
//                                 )}
//                             </div>
//                         );
...
//                 {/* 2. MIDDLE: PRESS OK TO WATCH (PLAYER) */}
//                 <div style={styles.playerWrapper(activeSection === 'player')}>
//                     {playingUrl ? (
//                         <ShakaPlayer url={playingUrl} drmToken={drmTokenUpdate}/>
//                     ) : (
...
//                 {/* 4. BOTTOM: ANIMATION MARQUEE */}
//                 <div style={{ display: 'flex', gap: '10px' }}>
//                     <div style={{ ...headerBaseStyle, width: '100%', border: '2px solid #333', overflow: 'hidden', backgroundColor: '#111', color: '#fff' }}>
//                         <div style={{ fontSize: '20px', fontWeight: 'bold', animation: 'marquee 15s linear infinite', whiteSpace: 'nowrap' }}>
//                              • Use Arrows to Navigate • Press Ok to Play • Enjoy Ulka TV •
//                         </div>
//                     </div>
//                 </div>
...
//         backgroundColor: '#FFFAE0', color: '#000', height: '60px',
//         display: 'flex', alignItems: 'center', justifyContent: 'center',
//         fontSize: '22px', fontWeight: '900', borderRadius: '4px', textTransform: 'uppercase'
//     };
...
//         },
//         container: { 
//             width: '95%', height: '92%', // Balanced margins for 4K Screen
//             backgroundColor: '#000', color: '#fff', 
//             display: 'flex', boxSizing: 'border-box', overflow: 'hidden', gap: '20px' 
//         },
//         sidebarColumn: { display: 'flex', flexDirection: 'column', backgroundColor: '#0a0a0a', gap: '10px', height: '100%', borderRadius: '10px', border: '1px solid #1a1a1a' },
//         scrollArea: { flex: 1, minHeight: 0, overflowY: 'auto', padding: '15px', scrollbarWidth: 'none' },
//         sidebarItem: (isFocused, isSelected) => ({
//             padding: '16px 12px', marginBottom: '14px', borderRadius: '8px', textAlign: 'center',
//             border: isFocused ? '4px solid #f00' : '2px solid transparent',
//             backgroundColor: isSelected ? '#222' : 'transparent',
//             color: isFocused ? '#f00' : (isSelected ? '#00D1FF' : '#fff'), 
//             fontSize: '21px', fontWeight: 'bold', transition: 'all 0.2s'
//         }),
//         rightPanel: { flex: 1, display: 'flex', flexDirection: 'column', gap: '15px', height: '100%' },
//         playerWrapper: (isFocused) => ({
//             flex: 1, backgroundColor: '#000', borderRadius: '12px', 
//             border: isFocused ? '6px solid #00D1FF' : '2px solid #222',
//             display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden'
//         }),
//         fullScreen: { position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', backgroundColor: '#000', zIndex: 9999 }
//     };
...
//                     {/* Channels Column */}
//                     <div style={{ ...styles.sidebarColumn, width: '240px' }}>
//                         <div style={headerBaseStyle}>Channels</div>
//                         <div style={styles.scrollArea} ref={chanRef}>
//                         {filteredChannels.map((ch, i) => {
//                             const isFocused = activeSection === 'channels' && focusedIdx === i;
...
//                                     justifyContent: 'center',
//                                     padding: '10px 0',
//                                     transform: isFocused ? 'scale(1.60)' : 'scale(1)', 
//                                     transition: 'transform 0.2s ease',
//                                     minHeight: '60px', // Ensures space for text when it appears
//                                     marginBottom: '15px',
//                                 }}>
//                                     <img src={ch.icon_url} alt={ch.title} style={{ 
//                                         width: '140px', 
//                                         height: '90px', 
//                                         objectFit: 'contain',
//                                         // border: isFocused ? '2px solid #f00' : 'none',
//                                         // borderRadius: '8px',
//                                         padding: '5px'
//                                     }} />

//                                     {/* Only show metadata when focused */}
//                                     {isFocused && (
//                                         <div style={{ 
//                                             marginTop: '0px', // No gap under icon
//                                             display: 'flex', 
//                                             alignItems: 'center', 
//                                             justifyContent: 'center',
//                                             gap: '4px', 
...
//                                             padding: '4px 0'
//                                         }}>
//                                             <span style={{ fontSize: '10px', color: '#f00' }}>{ch.channel_number}</span>
//                                             <span style={{ fontSize: '10px', color: '#f00' }}>.</span>
//                                             <span style={{ color: '#fff', fontSize: '10px', whiteSpace: 'nowrap' }}>{ch.title}</span>
//                                         </div>
//                                     )}
//                                 </div>
//                             );
...
//                         ) : (
//                             <div style={{ textAlign: 'center' }}>
//                                 {currentHover?.icon_url && <img src={currentHover.icon_url} alt="" style={{ height: '180px', marginBottom: '20px' }} />}
//                                 <h2 style={{ fontSize: '32px', color: '#00D1FF', fontWeight: 'bold' }}>PRESS OK TO WATCH</h2>
//                             </div>
//                         )}
//                     </div>
...
//                         {[1, 2, 3].map(n => (
//                             <div key={n} style={{ flex: 1, height: '90px', backgroundColor: '#1a1a1a', borderRadius: '6px', border: '1px solid #333', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px' }}>
//                                 Program {n}
//                             </div>
//                         ))}
//                     </div>
...
//                         <div style={{ ...headerBaseStyle, width: '100%', border: '2px solid #333', overflow: 'hidden', backgroundColor: '#111', color: '#fff' }}>
//                             <div style={{ fontSize: '24px', fontWeight: 'bold', animation: 'marquee 15s linear infinite', whiteSpace: 'nowrap' }}>
...
//     const styles = {
//         // Main Wrapper: Centers everything and prevents stretching
//         screenWrapper: {
//             width: '100vw', height: '100vh', backgroundColor: '#000',
//             display: 'flex', alignItems: 'center', justifyContent: 'center',
//             overflow: 'hidden'
//         },
//         // Content Container: Fixed 16:9 ratio to prevent right-side cutting
//         container: { 
//             width: '100%', 
//             maxWidth: '1920px', // Limits stretching on 4K
//             height: '100%', 
//             maxHeight: '1080px',
//             aspectRatio: '16 / 9', 
//             backgroundColor: '#000', 
...
//                                     justifyContent: 'center',
//                                     padding: '10px 0',
//                                     transform: isFocused ? 'scale(1.50)' : 'scale(1)', 
//                                     transition: 'transform 0.2s ease',
//                                     minHeight: '60px', // Ensures space for text when it appears
//                                     marginBottom: '15px',
//                                 }}>
...
//                 <div style={styles.rightPanel}>
//                     <div style={{ ...headerBaseStyle, height: '55px', fontSize: '22px' }}>ULKA TV ADVERTISEMENT</div>
...
//                         ) : (
//                             <div style={{ textAlign: 'center' }}>
//                                 {currentHover?.icon_url && <img src={currentHover.icon_url} alt="" style={{ height: '200px', marginBottom: '15px' }} />}
//                                 <h2 style={{ fontSize: '24px', color: '#00D1FF' }}>PRESS OK TO WATCH</h2>
//                             </div>
//                         )}
//                     </div>
...
//                     <div style={{ display: 'flex', gap: '10px' }}>
//                         {[1, 2, 3].map(n => (
//                             <div key={n} style={{ flex: 1, height: '100px', backgroundColor: '#00D1FF', borderRadius: '6px', border: '2px solid #0a0909ff', color: '#060606ff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px' }}>
//                                 Program {n}
//                             </div>
//                         ))}
//                     </div>

//                     <div style={{ height: '50px', backgroundColor: '#111', border: '1px solid #333', overflow: 'hidden', display: 'flex', alignItems: 'center' }}>
//                         <div style={{ color: '#fff', fontSize: '20px', animation: 'marquee 20s linear infinite', whiteSpace: 'nowrap', width: '100%' }}>
//                             • Use Arrows to Navigate • Press Ok to Play • Enjoy Ulka TV High Definition •
//                         </div>
//                     </div>
//                 </div>
...
//         // --- BACK BUTTON LOGIC FIXED HERE ---
//         if (e.key === 'Backspace' || e.key === 'Escape') {
//             e.preventDefault();
//             navigate('/exit'); // 3. Redirect to Exit Screen
//             return;
//         }
...
//             if (e.key === 'Enter' && playingUrl) setIsFullScreen(true);
//         }
//     }, [activeSection, focusedIdx, filteredChannels, allChannels, selectedCat, selectedLang, updateFilteredList, isFullScreen, playingUrl, navigate]);
...
const HomeScreen = ({ accessToken }) => {
    ...
    const loadChannel = useCallback(async (channel) => {
        if (!channel) return;
        try {
            const res = await getPallyTokenFromNetwork(channel.encryption_url);
            setDrmTokenUpdate(res.response_object[0].base64Token);
    ...
    const styles = {
        ...
        container: { 
            width: '90%', maxWidth: '1920px', height: '100%', maxHeight: '1080px',
