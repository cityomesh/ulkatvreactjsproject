...
// హెల్పర్ ఫంక్షన్ - చిత్రం URL ని Nginx ప్రాక్సీ ద్వారా మార్చడానికి
const getProxiedImageUrl = (originalUrl) => {
    if (!originalUrl) return '';
    // http://202.62.66.115:8080/1/files/channels/example.webp ని
    // https://app.ulka.tv/images/1/files/channels/example.webp గా మార్చండి
    const parts = originalUrl.split('/');
    const imagePath = parts.slice(3).join('/'); // "1/files/channels/example.webp"
    return `https://app.ulka.tv/images/${imagePath}`;
};
        ...
        <div style={styles.screenWrapper}>
            <div style={styles.container}>
                ...
                <div style={{ display: 'flex', gap: '12px', height: '100%' }}>
                    ...
                    {/* Channels Column - మార్పు చేసిన భాగం */}
                    <div style={{ ...styles.sidebarColumn, width: '230px' }}>
                        <div style={headerBaseStyle}>Channels</div>
                        <div style={styles.scrollArea} ref={chanRef}>
                        {filteredChannels.map((ch, i) => {
                            ...
                            return (
                                <div key={ch.id} style={{ 
                                    ...
                                    <img 
                                        src={getProxiedImageUrl(ch.icon_url)} 
                                        alt={ch.title} 
                ...
                {/* Right Panel - Player Section - మార్పు చేసిన భాగం */}
                <div style={styles.rightPanel}>
                    <div style={{ ...headerBaseStyle, height: '55px', fontSize: '20px' }}>ULKA TV ADVERTISEMENT</div>
                    <div style={styles.playerWrapper(activeSection === 'player')}>
                        {playingUrl ? (
                            ...
                            <div style={{ textAlign: 'center' }}>
                                {currentHover?.icon_url && 
                                    <img 
                                        src={getProxiedImageUrl(currentHover.icon_url)} 
                                        alt="" 
