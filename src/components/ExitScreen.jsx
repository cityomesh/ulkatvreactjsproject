...
// // 1. Image ni import chesukondi
// import backgroundImage from './assets/add_1.jpeg'; 
// const LOGO_ULKA = "ulkatv.png";

// const ExitScreen = () => {
//     const [selectedButton, setSelectedButton] = useState('change'); 
//     const [showConfirmation, setShowConfirmation] = useState(false);
//     // Slider state (imageIndex) avasaram ledu kabatti remove chesam
...
//         container: { display: 'flex', width: '100vw', height: '100vh', backgroundColor: '#000', overflow: 'hidden' },
//         leftPanel: { width: '75%', height: '100%', position: 'relative' },
//         // Slider transition ni remove chesi static image style petta
...
//         <div style={styles.container}>
//             <div style={styles.leftPanel}>
//                 {/* Single Background Image ikkada load avthundi */}
//                 <img src={backgroundImage} style={styles.bgImg} alt="Background" />
//             </div>
