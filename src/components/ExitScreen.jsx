...
//                 navigate('/profiles'); // ప్రొఫైల్స్ లిస్ట్ కి వెళ్తుంది
//             } else if (selectedButton === 'exit') {
//                 if (!showConfirmation) {
//                     setShowConfirmation(true);
//                 } else {
//                     navigate('/login'); // లాగిన్ కి వెళ్తుంది
//                 }
//             }
//         } else if (e.key === 'Backspace') {
//             e.preventDefault();
//             // ఒకవేళ కన్ఫర్మేషన్ బాక్స్ ఉంటే దాన్ని క్లోజ్ చేస్తుంది, లేదంటే హోమ్ కి వెళ్తుంది
//             if (showConfirmation) {
//                 setShowConfirmation(false);
//             } else {
//                 navigate('/home'); 
...
//             alignItems: 'center', 
//             justifyContent: 'center', // సెంటర్‌కు తెస్తుంది
//             padding: '0 40px',
//             gap: '25px' // ఎలిమెంట్స్ మధ్య సమాన గ్యాప్
//         },
//         title: { 
//             color: '#fff', 
//             fontSize: '48px', 
...
//                                 Are you sure? <br/> Press ENTER to Login
//                             </div>
//                         )}
//                     </div>
//                 </div>
...
const ExitScreen = () => {
    ...
    const [showConfirmation, setShowConfirmation] = useState(false);
    const [imageIndex, setImageIndex] = useState(0);
    // LocalStorage నుండి యూజర్ నేమ్ తీసుకుంటున్నాము
